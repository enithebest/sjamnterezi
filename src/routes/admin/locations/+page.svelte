...
<a href="/admin/locations/new" class="create-event-btn">+ Create New Event</a>
...
{#each data.locations as locations (locations.id)}
	<div class="box" transition:slide>
		<div class="content">
			<p class="location-title">{locations.name}</p>
			<p class="location-id">Event ID: {locations.id}</p>
		</div>
